 ...
 * Use the [DonateToSheltersFragment.newInstance] factory method to
...
class DonateToSheltersFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment DonateToSheltersFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            DonateToSheltersFragment().apply {
