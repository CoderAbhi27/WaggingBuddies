 ...
 * Use the [ContactVeterinaryFragment.newInstance] factory method to
...
class ContactVeterinaryFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment ContactVeterinaryFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            ContactVeterinaryFragment().apply {
